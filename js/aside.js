  ...
  var MENU = {
    ...
    groups: [
      ...
      /* ── BRAND ── */
      {
        ...
        label: "Brand",
        directItems: [
          { href: "/page/brand/brand-product.html",       label: "Products",            key: "brand-products" },
        ...
        subGroups: [
          {
            id: "grp-brand-pricing",           
            label: "Brand pricing",            
            items: [
              { href: "#",        label: "MSRP / Pricing Policy",             key: "brand-pricing-msrp" },
              // { href: "#",      label: "Pricing Policy",   key: "brand-pricing-policy" }
            ]
          }
        ]
      },
